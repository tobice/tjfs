...
public class IpDetect {
     ...
     * returned. If Zookeeper and this machine are not in the same subnet then this method fails,
     * but this requirement is reasonable as it is easy to meet.
     *
     ...
     *  the list of current network interfaces and their IP addresses, or if there is no IP address
     *  in the same subnet as Zookeeper's IP.
     */
        ...
        try {
            ...
            for (Enumeration ifaces = NetworkInterface.getNetworkInterfaces(); ifaces.hasMoreElements(); ) {
                ...
                for (InterfaceAddress address : iface.getInterfaceAddresses()) {
                    ...
                    if (sameSubnet(ip, zookeeperIp, address.getNetworkPrefixLength())) {
